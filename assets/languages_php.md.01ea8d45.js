...
<span class="line"></span></code></pre></div><h3 id="使用-yaml-扩展" tabindex="-1">使用 Yaml 扩展 <a class="header-anchor" href="#使用-yaml-扩展" aria-hidden="true">#</a></h3><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-VXVrt" id="tab-XKO59Ye" checked="checked"><label for="tab-XKO59Ye">将 Yaml 转为 PHP 数组</label><input type="radio" name="group-VXVrt" id="tab-tPwfG39"><label for="tab-tPwfG39">将 PHP 数组转成 Yaml 格式</label></div><div class="blocks"><div class="language-php active"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">## 1. 读内容并转换成数组</span></span>
...
<span class="line"></span></code></pre></div></div></div><h2 id="yaml-组件" tabindex="-1">Yaml 组件 <a class="header-anchor" href="#yaml-组件" aria-hidden="true">#</a></h2><h3 id="安装-symfony-yaml-组件" tabindex="-1">安装 <code>symfony/yaml</code> 组件 <a class="header-anchor" href="#安装-symfony-yaml-组件" aria-hidden="true">#</a></h3><p>下载地址：<a href="http://pecl.php.net/package/yaml" target="_blank" rel="noreferrer">http://pecl.php.net/package/yaml</a></p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">composer</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">require</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">symfony/yaml</span></span>
<span class="line"></span></code></pre></div><h3 id="使用-symfony-yaml-组件" tabindex="-1">使用 <code>symfony/yaml</code> 组件 <a class="header-anchor" href="#使用-symfony-yaml-组件" aria-hidden="true">#</a></h3><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-s_ACM" id="tab-_KgtcZl" checked="checked"><label for="tab-_KgtcZl">将 Yaml 转为 PHP 数组</label><input type="radio" name="group-s_ACM" id="tab-qWnGK2a"><label for="tab-qWnGK2a">将 PHP 数组转成 Yaml 格式</label></div><div class="blocks"><div class="language-php active"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">## 1. 读内容并转换成数组</span></span>
<span class="line"><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">contents </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&lt;&lt;&lt;Yaml</span></span>
<span class="line"><span style="color:#C3E88D;">php:</span></span>
<span class="line"><span style="color:#C3E88D;">preset: laravel</span></span>
<span class="line"><span style="color:#C3E88D;">disabled:</span></span>
...
<span class="line"><span style="color:#C3E88D;">css: true</span></span>
<span class="line"><span style="color:#89DDFF;">Yaml</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">value    </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Yaml</span><span style="color:#89DDFF;">::</span><span style="color:#82AAFF;">parse</span><span style="color:#89DDFF;">($</span><span style="color:#A6ACCD;">yaml_str</span><span style="color:#89DDFF;">);</span></span>
<span class="line"><span style="color:#82AAFF;">print_r</span><span style="color:#89DDFF;">($</span><span style="color:#A6ACCD;">value</span><span style="color:#89DDFF;">);</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">## 2. 读文件并转换成数组（将上面的 $contents 内容写入文件 .styleci.yml 文件）</span></span>
<span class="line"><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">value </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Yaml</span><span style="color:#89DDFF;">::</span><span style="color:#82AAFF;">parseFile</span><span style="color:#89DDFF;">(</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">./.styleci.yml</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">);</span></span>
<span class="line"><span style="color:#82AAFF;">print_r</span><span style="color:#89DDFF;">($</span><span style="color:#A6ACCD;">value</span><span style="color:#89DDFF;">);</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">## 以上打印均输出如下：</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;"># Array</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;"># (</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">#     [php] =&gt; Array</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">#         (</span></span>
...
<span class="line"><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">yaml  </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Yaml</span><span style="color:#89DDFF;">::</span><span style="color:#82AAFF;">dump</span><span style="color:#89DDFF;">($</span><span style="color:#A6ACCD;">array</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> </span><span style="color:#F78C6C;">4</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> </span><span style="color:#F78C6C;">2</span><span style="color:#89DDFF;">);</span></span>
<span class="line"><span style="color:#82AAFF;">file_put_contents</span><span style="color:#89DDFF;">(</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">./.styleci.yaml</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">yaml</span><span style="color:#89DDFF;">);</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">## 写入的文件内容如下：</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;"># php:</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">#   preset: laravel</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">#   disabled:</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">#     - no_unused_imports</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;"># js: true</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;"># css: true</span></span>
<span class="line"></span></code></pre></div></div></div>`,15),e=[o];function t(c,r,y,i,D,F){return n(),a("div",null,e)}const d=s(p,[["render",t]]);export{A as __pageData,d as default};
