...
<span class="line"></span></code></pre></div><h3 id="使用-yaml-扩展" tabindex="-1">使用 Yaml 扩展 <a class="header-anchor" href="#使用-yaml-扩展" aria-hidden="true">#</a></h3><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-5ihaK" id="tab-tKhGVPa" checked="checked"><label for="tab-tKhGVPa">将 Yaml 转为 PHP 数组</label><input type="radio" name="group-5ihaK" id="tab-4AeWQc4"><label for="tab-4AeWQc4">将 PHP 数组转成 Yaml 格式</label></div><div class="blocks"><div class="language-php active"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">## 1. 读内容并转换成数组</span></span>
...
<span class="line"></span></code></pre></div><h3 id="使用-symfony-yaml-组件" tabindex="-1">使用 <code>symfony/yaml</code> 组件 <a class="header-anchor" href="#使用-symfony-yaml-组件" aria-hidden="true">#</a></h3><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-zU87u" id="tab-esGO6Eq" checked="checked"><label for="tab-esGO6Eq">将 Yaml 转为 PHP 数组</label><input type="radio" name="group-zU87u" id="tab-Sj2PfL4"><label for="tab-Sj2PfL4">将 PHP 数组转成 Yaml 格式</label></div><div class="blocks"><div class="language-php active"><button title="Copy Code" class="copy"></button><span class="lang">php</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">## 1. 读内容并转换成数组</span></span>
<span class="line"><span style="color:#89DDFF;">$</span><span style="color:#A6ACCD;">contents </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&lt;&lt;&lt;Yaml</span></span>
<span class="line"><span style="color:#C3E88D;">php:</span></span>
<span class="line"><span style="color:#C3E88D;">preset: laravel</span></span>
<span class="line"><span style="color:#C3E88D;">disabled:</span></span>
