...
<span class="line"><span style="color:#676E95;font-style:italic;">#   }</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;"># }</span></span>
<span class="line"></span></code></pre></div><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-hidden="true">#</a></h2><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-Zgou5" id="tab-FzWRXmf" checked="checked"><label for="tab-FzWRXmf">将 Yaml 转为 JSON</label><input type="radio" name="group-Zgou5" id="tab-RIt3MRL"><label for="tab-RIt3MRL">将 JSON 转成 Yaml</label></div><div class="blocks"><div class="language-javascript active"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 1. 读内容并转换成json对象</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">//js: true</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">//css: true</span></span>
<span class="line"></span></code></pre></div></div></div>`,8),e=[o];function t(c,r,i,y,D,C){return a(),n("div",null,e)}const d=s(p,[["render",t]]);export{A as __pageData,d as default};
